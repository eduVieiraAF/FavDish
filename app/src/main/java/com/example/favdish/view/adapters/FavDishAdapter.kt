...
class FavDishAdapter(private val fragment: Fragment) : RecyclerView
.Adapter<FavDishAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (fragment is AllDishesFragment) holder.ibMore.visibility = View.VISIBLE
        else if (fragment is FavoriteDishesFragment) holder.ibMore.visibility = View.GONE
    }
